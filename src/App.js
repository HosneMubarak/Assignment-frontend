...
class App extends React.Component {
    ...
    getFlightData = async (e) => {
        ...
        // getting flight data
        const fetchResponse = await fetch(`http://127.0.0.1:8000/flight/`, settings)
        ...
        if (data.data === null) {
            ...
            this.setState({
                flight_list: data.data[destination],
            })
        }
    ...
    render() {
        return (
            <div className="App" style={{background: "#e9ecef"}}>
                ...
                <Weather weather_data={this.state.weather_data} weather_data2={this.state.weather_data2} flight_list={this.state.flight_list}/>
